...
},{"../../../data/about.json":22}],2:[function(require,module,exports){
'use strict';

var imageHtml = '<li class="background-image">\n  <div class="image" style="background-image:url(\'<%= image.src %>\')"></div>\n  <div class="shield"></div>\n  <span class="description"><%= image.description %></span>\n</li>';
...
},{"./aboutModel.js":1}],3:[function(require,module,exports){
'use strict';

Portfolio.Models.App = module.exports = Backbone.Model.extend(require('../../../data/info.json'));

},{"../../../data/info.json":23}],4:[function(require,module,exports){
'use strict';

var appHtml = '<div class="portfolio">\n  <div class="content-container"></div>\n</div>';
...
Portfolio.Views.App = module.exports = Backbone.View.extend({
  ...
  createRoutes: function createRoutes() {
  ...
  routeSection: function routeSection(paramSection) {
  ...
  build: function build(view, data) {
...
},{"../navbar/navbar.js":11,"../router/router.js":20,"../slidebar/slidebar.js":21,"./appModel.js":3}],5:[function(require,module,exports){
'use strict';
...
Portfolio.Views.Blog = module.exports = Backbone.View.extend({
  ...
  onInteractionSelectedPost: function onInteractionSelectedPost() {
  ...
  scrollToPost: function scrollToPost(postId) {
...
},{"../interactions/interactionsManager.js":9,"../posts/postsView.js":15}],6:[function(require,module,exports){
'use strict';
...
_.extend(Portfolio, {
  ...
  loadImageStyle: function loadImageStyle() {
    var $el = $(this);
    $el.addClass('loading');
    $el.one('load', function () {
      _.delay(function () {
        $el.removeClass('loading');
      }, Portfolio.ANIMATION_DURATION);
    });
  },
...
},{"./hydrate.js":7,"backbone":29,"headroom.js":30,"jquery":31,"underscore":32,"unveil/unveil.js":33}],7:[function(require,module,exports){
'use strict';
...
(function setHydrate() {
  var hydration = {
    hydrate: function hydrate() {
      // returns the first successful sync or abort if router fires first
      if (!this.hydrated) {
        // check that the model has not called onHydrate
    ...
    onHydrate: function onHydrate() {}, // noop
    onNoHydrate: function onNoHydrate() {
...
Backbone.sync = _.wrap(Backbone.sync, function (sync, method, model, options) {
  var syncFunction = function syncFunction() {
    ...
    var doSync;
    try {
      doSync = sync(method, model, options);
    } catch (e) {
      doSync = Promise.resolve();
    } // no url

    if (!model.promise && method !== 'delete') {
      // first sync always hydrates
      model.promise = doSync.then(undefined, function () {
        // reject only
        model.promise = null;
        return Promise.reject();
      });
...
function mixPanelUser() {
  ...
  if (randomUserId === null) mixpanel.identify();else mixpanel.identify(randomUserId);
}

function initialize(view, namespace) {
  if (typeof mixpanel === 'undefined') {
    window.mixpanel = {
      track: function track(action, metadata, callback) {
  ...
  add: function add(object, name, options) {
    ...
    this.on('change:' + key, function () {
      var trigger = function trigger() {
        object.trigger('interaction:' + name, object);
      };
      if (options.callback) Promise.resolve(options.callback(object)).then(trigger);else trigger();
    });
  }
});
...
var navbarHtml = '<div id="friendlies">\n  <% _.each(friendlies, function (friendly) { %> \n    <a id="<%= friendly.name %>" href="<%= friendly.url %>">\n      <i class="fa fa-<%= friendly.name %>"></i>\n    </a>\n  <% }); %>\n</div>\n<a href=\'/\'>\n  <header id="portfolio-name">\n    <span id="mini"><%= mini %></span>\n    <span id="truncated"><%= truncated %></span>\n    <span id="full"><%= full %></span>\n  </header>\n</a>\n<div id="descriptors">\n  <% _.each(descriptors, function (descriptor) { %>\n    <a href="<%= descriptor.url %>">\n      <span><%= descriptor.name %></span>\n    </a>\n  <% }); %>\n</div>\n';
...
Portfolio.Views.Navbar = module.exports = Backbone.View.extend({
  ...
  updateScroller: function updateScroller(view) {
    this.headroom.updateScroller(view);
  }
});
  ...
  initialize: function initialize() {
    ...
    if (type === 'photo') {
      _.each(this.get('photos'), function (photo) {
        var img = '<img src="' + photo['original_size'].url + '" />',
            caption = '';
...
var postHtml = '<a class="post-title" href="<%= \'/blog/\' + post.get(\'id\') %>">\n  <span class="title"><%= post.get(\'title\') %></span>\n  <span class="date">\n    <span class="date-content"><%= post.get(\'date\').slice(0, 10) %></span>\n  </span>\n</a>\n<div class="post-body"><%= post.get(\'body\') %></div>\n';
...
},{"./postModel.js":12}],15:[function(require,module,exports){
'use strict';
...
Portfolio.Views.Posts = module.exports = Backbone.View.extend({
  ...
  render: function render() {
    ...
    _.defer(function () {
      this.lazyImageLoader.unveil();
    }.bind(this));
    return this;
  },

  renderPost: function renderPost(model) {
...
},{"./postView.js":13,"./postsCollection.js":14}],16:[function(require,module,exports){
'use strict';

Portfolio.Models.Projects = module.exports = Backbone.Model.extend(require('../../../data/projects.json'));

},{"../../../data/projects.json":24}],17:[function(require,module,exports){
'use strict';

var projectHtml = '<li class="project">\n  <div class="wrapper">\n    <header class="title"><%= project.title %></header>\n    <a class="image-wrapper" href="<%= project.url %>"><img src="<%= project.image %>"/></a>\n    <div class="description">\n      <% _.each(project.description, function (detail) { %>\n        <span class="detail"><%= detail %></span>\n      <% }); %>\n    </div>\n  </div>\n</li>\n';
...
},{"./projectsModel.js":16}],18:[function(require,module,exports){
'use strict';

Portfolio.Models.Resume = module.exports = Backbone.Model.extend(require('../../../data/resume.json'));

},{"../../../data/resume.json":25}],19:[function(require,module,exports){
'use strict';

var resumeHtml = '<div class="wrapper">\n  <% _.each([resume.education, resume.professional], function (section) { %>\n    <li class="section" id=<%= section.name %>>\n      <header class="section-header">\n        <span><%= section.name %></span>\n      </header>\n      <% _.each(section.positions, function (position) { %>\n        <div class="position">\n          <div class="position-info">\n            <span class="title"><%= position.title %>, </span>\n            <span class="institution"><%= position.name %></span></span>\n          </div>\n          <ol class="content">\n            <% _.each(position.details, function (detail) { %>\n              <li class="detail"><%= detail %></li>\n            <% }); %>\n          </ol>\n          <div class="date-range">\n            <span class="date-begin"><%= position.date_range[0] %></span>\n            <span class="date-end"><%= position.date_range[1] %></span>\n          </div>\n        </div>\n      <% }); %>\n    </li>\n  <% }); %>\n  <li class="section" id="skills">\n    <header class="section-header"><span>skills</span></header>\n    <% _.each(resume.skills, function (skill) { %>\n      <div class="skill-block">\n        <span class="title"><%= skill.title %></span>\n        <div class="details">\n          <% _.each(skill.details, function (detail) { %>\n            <span class="detail" data-id="<%= detail %>"><%= detail %></span>\n          <% }); %>\n        </div>\n      </div>\n    <% }); %>\n  </li>\n</div>\n';
...
},{"./resumeModel.js":18}],20:[function(require,module,exports){
'use strict';

Portfolio.Utilities.Router = module.exports = Backbone.Router.extend({
  routes: { '*notFound': 'notFound' },

  initialize: function initialize(notFoundCallback) {
    this.notFoundCallback = notFoundCallback;
  },

  promise: function promise() {
    return new Promise(function (resolve, reject) {
      // start listening after the current stack
      _.defer(function () {
        this.once('route', reject);
      }.bind(this));
    }.bind(this));
  },
...
var slideBarHtml = '<div id="selector"><span></span></div>\n<% _.each(sections, function (section) { %>\n  <a id="<%= section %>" href="/<%= section %>"><span><%= section %></span></a>\n<% }); %>';
...
Portfolio.Views.Slidebar = module.exports = Backbone.View.extend({
  ...
  render: function render(section) {
  ...
  moveSelector: function moveSelector() {
...
module.exports={
  "images": [
  {
    "src": "dist/assets/img/google.jpg",
    "description": "I am a frontend developer at Google."
  },
  {
    "src": "dist/assets/img/roma.jpg",
    "description": "I've lived in Paris, Mexico City, Singapore, and now Palo Alto."
  },
  {
    "src": "dist//assets/img/lostcoast.jpg",
    "description": "California's Lost Coast is one of many reasons I'll keep put here."
  },
  {
    "src": "dist/assets/img/trinity.jpg",
    "description": "I like photography, surfing and backpacking. (Trinity Alps)."
  },
  {
    "src": "dist/assets/img/friends.jpg",
    "description": "These are what my friends look like in silhoutte form."
  },
  {
    "src": "dist/assets/img/jake.jpg",
    "description": "Not sure how to end this, but it's the internet so here's my old cat Jake looking at a turtle."
  }
  ]
}
...
module.exports={
  ...
  "friendlies": [
    ...
    {
      "url": "https://www.linkedin.com/in/dannycochran",
      "name": "linkedin-special"
    },
    {
      "url": "https://twitter.com/dannycochran",
      "name": "twitter-special"
    }
  ],
  "descriptors": [
    {
      "url": "https://gse-ldt.stanford.edu/",
      "name": "M.A, Stanford LDT"
    },
    {
      "url": "https://www.google.com/",
      "name": "Frontend Engineer, Google"
    }
  ],
  "description": ["I am currently a frontend engineer at Google."]
}
...
module.exports={
  "projects": [
    {
      "title": "Grasshopper",
      "image": "dist/assets/img/grasshopper.png",
      "url": "https://play.google.com/store/apps/details?id=com.area120.grasshopper&hl=en",
      "year": [2016, 2018],
      "description": ["Grasshopper is an Area120 product I co-founded. It's a React-Native mobile app that teaches you how to code by composing real JavaScript, without needing to worry about syntax. It's aimed at beginners and career changers.", "We are currently deployed on Android, and coming soon to iOS."]
    },
    {
      "title": "Ayasdi Core",
      "image": "dist/assets/img/core.jpg",
      "url": "https://core.ayasdi.com",
      "years": [2013, 2015],
      "description": ["Ayasdi Core is what I spend most of time working on as a frontend engineer for Ayasdi.", "Core is the first of several applications Ayasdi is building to help industries explore large, complex data sets with digestible visualizations. It is built with minimal dependencies (Backbone, D3, ), and with a design framework we have created that extends across all of our applications."]
    },
    {
      "title": "Strummify",
      "image": "dist/assets/img/strummify.jpg",
      "url": "http://www.strummify.com/",
      "years": [2012, 2013],
      "description": ["Strummify is a web application for learning guitar. I taught myself how to code using sites like Udacity & Codeacademy, and figured that the same approach could be taken for musical instruments. The goal was to provide real time, interactive feedback on your guitar playing. Employing the help of some friends, we created a prototype that included polyphonic pitch detection and a simple user interface.", "Unfortunately, Strummify has not had much love and support since I finished my Masters program at Stanford. The pitch detection needs significant improvement and the backend, created somewhat hastily towards the end of the quarter, is in need of repairs."]
    },
    {
      "title": "Visualizing New York Hospital Data",
      "image": "dist/assets/img/nyhealth.jpg",
      "url": "http://thebeautyofhealthdata.org/?p=348",
      "years": [2014],
      "description": ["This static visualization (click above for complete image) was created for the Beauty of Health Data contest that took place in Summer of 2014. My entry won the category for Best Data Exploration."]
    },
    {
      "title": "Climate Change Comes Home",
      "image": "dist/assets/img/climate.jpg",
      "url": "http://climatechange.herokuapp.com/",
      "years": [2014],
      "description": ["This article was a small side project designed & hosted for the Stanford Peninsula Press."]
    },
    {
      "title": "Twitter Activity & Hurricane Sandy",
      "image": "dist/assets/img/sandy.jpg",
      "url": "http://bl.ocks.org/dannycochran/raw/5689222/",
      "years": [2013],
      "description": ["This data visualization was my final project for CS448B: Data Visualization. Myself and three other students wanted to reimagine text visualizations, which mostly consist of word clouds today.", "By providing context on the sentiment of the word and its frequency over time, we hoped to let people dig deeper into text analysis."]
    },
    {
      "title": "Costs of Living",
      "image": "dist/assets/img/costs.jpg",
      "url": "http://bl.ocks.org/dannycochran/raw/4349896/",
      "description": ["My first endeavor with creating a D3.js visualization, I can still remember agonizing over what, at the time, seemed like an obscure and unintelligble D3 api."],
      "year": [2013]
    },
    {
      "title": "Disgo",
      "image": "dist/assets/img/disgo.jpg",
      "url": "",
      "years": [2012],
      "description": ["Disgo was a jQuery-mobile application I built with two other students for CS147: Human Computer Interaction. Our goal was to create an application where people started conversations regarding specific places of interest.", "At its peak, Disgo had upwards of 20 users. Unfortunately, Stanford discontinued my personal student directory once I graduated, and Disgo is now disgone."]
    },
    {
      "title": "Yogiplay UX & UI",
      "image": "dist/assets/img/yogiplay.jpg",
      "url": "http://yogiplay.com/",
      "years": [2012],
      "description": ["Yogiplay was a mobile app startup designed to help parents pick quality educational applications for their kids.", "We had a common, but still unsolved challenge in that we wanted to target all mobile devices using HTML5. This was my first introduction to responsive design, and as I was purely on the design side of this project (and not on engineering), I now sympathize greatly with the <a href='http://www.marcosiglesias.com/home'>sole frontend engineer</a> on the project."]
    }
  ]
}
},{}],25:[function(require,module,exports){
module.exports={
  "website": "dcochran.com",
  "name": "Daniel Cochran",
  "education": {
    "name": "education",
    "positions": [{
      ...
      "details": ["Education: Learning, Design & Technology", "Final project: http:www.strummify.com"],
      "date_range": ["8.2012", "8.2013"]
    },
    {
      "title": "B.A",
      "name": "Lewis & Clark College",
      "details": ["Major: Political Science", "Minor: Economics"],
      "date_range": ["8.2005", "5.2009"]
    }]
   },
  "professional": {
    "name": "professional",
    "positions": [{
      ...
      "details": ["Creating web application for SMB Revenue Innovations"],
      "date_range": ["8.2015", "present"]
    },
    {
      "name": "Ayasdi",
      "title": "Frontend engineer",
      "details": ["Creating web application for interactive data analysis","Designing features from wireframe to implementation"],
      "date_range": ["8.2013", "8.2015"]
    },
    {
      "name": "Stanford University",
      "title": "Frontend engineer",
      "details": ["Designed mobile application for distribution in schools"],
      "date_range": ["1.2013", "5.2013"]
    },
    {
      "name": "Yogiplay",
      "title": "UX Designer",
      "details": ["Designed HTML5 web application for mobile and tablet devices"],
      "date_range": ["1.2012", "1.2013"]
    },
    {
      "name": "Ympyra",
      "title": "UX Designer",
      "details": ["Led development of mobile learning project for 5th graders"],
      "date_range": ["12.2010", "1.2012"]
    },
    {
      "name": "Americorps",
      "title": "Site lead",
      "details": ["Taught and led afterschool program in South San Jose"],
      "date_range": ["12.2009", "12.2010"]
    }]
  },
  "skills": [
    {
      "title": "Programming Languages",
      "details": ["Javascript", "Python", "Ruby on Rails", "Java", "HTML/CSS", "SASS"]
    },
    {
      "title": "Library Specialties",
      "details": ["Mithril", "React", "D3", "Paper", "Node"]
    },
    {
      "title": "Design Tools",
      "details": ["Adobe Photoshop & Illustrator", "Omnigraffle", "Pixelmator"]
    },
    {
      "title": "Professional Interests",
      "details": ["data visualization", "interactive web applications", "digital education", "photography"]
    }]
}
...
},{"../../common/modules/globals/initialize.js":8,"../modules/app/appView.js":27,"../modules/globals/globals.js":28}],27:[function(require,module,exports){
'use strict';
...
DC.Views.App = module.exports = AppView.extend({
  ...
  routePostId: function routePostId(paramPostId) {
...
},{"../../../common/modules/about/aboutView.js":2,"../../../common/modules/app/appView.js":4,"../../../common/modules/blog/blog.js":5,"../../../common/modules/projects/projectsView.js":17,"../../../common/modules/resume/resumeView.js":19}],28:[function(require,module,exports){
'use strict';
...
},{"../../../common/modules/globals/globals.js":6}],29:[function(require,module,exports){
(function (global){
//     Backbone.js 1.3.3
