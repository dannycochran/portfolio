Portfolio.Utilities.Router = module.exports = Backbone.Model.extend({
  ...
  spinner: _.template(require('./spinner.html')),
  ...
  notFound: function () { this.routeApp(); },

  routeApp: function () { this.app.renderGame(); },
